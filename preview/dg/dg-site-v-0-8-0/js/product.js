...
const products = [
    ...
    { title: "DOI - Continuous Testing Foundation (CTF)℠", description: "Continuous Testing enables faster, higher quality releases and reduced costs by seamlessly integrating into the Continuous Delivery process to identify and address risks at all stages of the development pipeline thereby minimizing business risk and impact on customers.", imgSrc: "../assets/assets_dg-site/logo/new logo for cources/Devops Insitute - DOI.jpg", category: "Devops Insitute - DOI" },
    { title: "DOI - DevOps Engineering Foundation℠", description: "DevOps is a software development methodology that combines software development (Dev) with information technology operations (Ops).", imgSrc: "../assets/assets_dg-site/logo/new logo for cources/Devops Insitute - DOI.jpg", category: "Devops Insitute - DOI" },
    { title: "DOI - Observability Foundation℠", description: "Observability Foundation introduces a range of best practices for building full-stack observability towards advancing resilience in a distributed ecosystem.", imgSrc: "../assets/assets_dg-site/logo/new logo for cources/Devops Insitute - DOI.jpg", category: "Devops Insitute - DOI" },
...
//         courseCard.setAttribute('data-category', product.category);
...
//         // Append the course card to the product container
//         productContainer.appendChild(courseCard);
//     });

//     // Call filterCourses to apply the initial filter based on default checkbox states
//     filterCourses();
// }

// function filterCourses() {
//     // Re-query checkboxes and courses to ensure they include dynamically added elements
//     const checkboxes = document.querySelectorAll('.form-check-input');
//     const courses = document.querySelectorAll('.course');

//     // Collect the selected categories from checked checkboxes
...
//     // Iterate over each course and display or hide based on selected categories
//     courses.forEach(course => {
//         const courseCategory = course.getAttribute('data-category');

//         // Show course if it matches any selected category or if "All" is selected
//         if (selectedCategories.length === 0 || selectedCategories.includes('All') || selectedCategories.includes(courseCategory)) {
...
//     generateCourses(); // Populate courses on page load

//     // Query checkboxes after generating courses
//     const checkboxes = document.querySelectorAll('.form-check-input');
